    ...
    */
    public static void main(String[] args) {
        ...
        */
        ...
        StudentList.add(new Student("Nguyễn Thái Nguyên", null));
        StudentList.add(new Student("Vũ Tiến Vinh", 8.2));
        StudentList.add(new Student("Bùi Hoàng Dũng", null));
        StudentList.add(new Student("Nguyễn Hoàng Định", 9.8));
