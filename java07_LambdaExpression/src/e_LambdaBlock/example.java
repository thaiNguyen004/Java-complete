 ...
 * giá trị cùng kiểu.
 * Giao diện SomeFunc được sử dụng để cung cấp một tham chiếu đến hai loại biểu thức lambda khác nhau.
 * Loại đầu tiên sử dụng kiểu String. Loại thứ hai sử dụng kiểu Integer. Do đó, cùng một giao diện hàm
 * có thể được sử dụng để tham chiếu đến biểu thức lambda đảo ngược và biểu thức lambda của giai thừa.
 * Chỉ có đối số kiểu được truyền vào SomeFunc khác nhau.*/
